    ...
    <div className="header-right flex items-center gap-x-6 h-full flex-1 basis-0 justify-end">
      <div className="hidden small:flex items-center gap-x-6 h-full">
        <div className="icon-group flex text-black">
          ...
          <div className="relative currency-wrapper group">
            <div className="flex items-center justify-center text-black cursor-pointer">
              <i className="las la-pound-sign"></i>

              <div className="drop absolute left-1/2 top-3 transform -translate-x-1/2 mt-6 w-20 bg-white border border-gray-300 rounded shadow-md z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
