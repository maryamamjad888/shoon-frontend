...
useEffect(() => {
  ...
  return (
    ...
    <header
    className={`mobnav w-full bg-white border-ui-border-base sm:hidden duration-200 ${
  ...
  >
      ...
      <div className="flex justify-center mobban  gap-12 py-1 h-12">
        ...
        >
          <FontAwesomeIcon icon={activePanel ? faXmark : faBars} size="2x" className="text-black text-2xl transform scale-x-120 scale-y-90" />
      ...
      {(activePanel === 'menu' || activePanel === 'search') && (
        <div className="content-container nav-bar flex flex-col items-start gap-y-4 p-4 text-small-regular bg-white border-t border-gray-300">
