...
const InfoSection = () => {
    return (
        <div className="info-row flex flex-col md:flex-row justify-between text-center items-center gap-10 py-12 px-4 md:px-20 bg-white">
            <div className="flex flex-col items-center max-w-xs">
            <LocalizedClientLink
                    href=""
                >
                <i className="las la-truck mb-3"></i>
                <h3 className="text-2xl font-semibold">Free UK Delivery</h3>
            ...
            <div className="flex flex-col items-center max-w-xs">
                ...
                >
                    ...
                    <h3 className="text-2xl font-semibold mt-3">Buy Now, Pay Later</h3>
                    <p className="text-sm mt-2 text-gray-700">
                        Experience a better way to shop. Buy now and pay 30 days later.
                    </p>
                    <p className="text-xs mt-1 text-gray-500">
                        18+, T&amp;C apply, credit subject to status,<br />
            ...
            <LocalizedClientLink
                ...
                <h3 className="text-2xl font-semibold">Click and Collect</h3>
                <p className="text-sm mt-2 text-gray-700">
            ...
            <LocalizedClientLink
                ...
                <div>
                    {[...Array(4)].map((_, i) => (
                        <i key={i} className="las la-star last-icon mb-3"></i>
                    ))}
                    <i className="las la-star-half-alt last-icon mb03"></i>
                </div>
