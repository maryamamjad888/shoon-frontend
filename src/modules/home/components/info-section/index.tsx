...
const InfoSection = () => {
    return (
  <div className="info-row grid grid-cols-1 md:grid-cols-2 w-fit mx-auto md:w-fit md:mx-auto lg:grid-cols-4 text-center items-start gap-10 py-12 px-4 md:px-20 bg-white">
            ...
            <LocalizedClientLink
                ...
                <p className="text-[12px] sm:text-sm mt-2 text-center text-gray-700">
                    We offer free delivery in the UK, with next day and international delivery also available.
                </p>
                </LocalizedClientLink>
            </div>

            <div className="flex flex-col items-center sm:-mt-5 max-sm:mt-4 max-w-xs">
                {/* max-sm:-ml-4 */}
                <LocalizedClientLink
                    href=""
                >
                    ...
                    <p className="text-[8px] sm:text-xs mt-1  text-center text-gray-500">
            ...
            <LocalizedClientLink
                ...
                <p className="text-[12px] sm:text-smmt-2 text-center text-gray-700">
